...
import { CheckCircle2, Circle, TrendingUp, Home, Zap, Heart, DollarSign, Calendar, Target, Award, Settings, Calculator, PieChart, BarChart3, Sparkles, Trophy, Star, Bell, Download, Upload, Users, Car, MapPin, Clock, Book, Gamepad2, Mountain, Music, Coffee, Utensils, CalendarHeart, Smile, Gift, Sunrise, Moon, Sun, CloudRain, Activity, Battery, Fuel, Navigation, ChevronRight, ChevronDown, PlayCircle, CheckSquare, Camera, Mic, Plus, TrendingDown, Flame, Baby, Cake, Syringe, Ruler, FileText, MessageSquare, Image, Lightbulb, Brain, Repeat, AlertCircle, Edit2, X, Save, Calendar as CalendarIcon } from 'lucide-react';
import { LineChart, Line, AreaChart, Area, PieChart as RePieChart, Pie, Cell, BarChart, Bar, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
